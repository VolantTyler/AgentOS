...
|--------|--------------------------------------|
| **University of Pennsylvania** | [events.seas.upenn.edu](https://events.seas.upenn.edu/), [Penn Research in Machine Learning (PRIML)](https://priml.upenn.edu/events-and-seminars/), [Wharton AI & Analytics](https://ai-analytics.wharton.upenn.edu/), [GRASP](https://www.grasp.upenn.edu/), course hubs (e.g. [Designing LLM Agents CIS 1990](https://designing-agents-upenn.github.io/) for related public lectures) |
...
Include a digest subsection **University-affiliated (Penn & NJ)** when any rows qualify. If none in-window, say so explicitly and list calendars to watch.
